...
This will extract character names and codings from a dataset.  It's been written to work with datasets downloaded from [MorphoBank](https://morphobank.org/), but my aim is for this function to handle most valid (and many invalid) NEXUS files. 
If you find a file that this function can't handle, please [let me know](https://github.com/ms609/TreeSearch/issues/new?title=Unsupported+NEXUS+file&body=Please%20attach%20the%20problematic%20NEXUS%20file%20and%20describe%20the%20issue&labels=enhancement) and I'll try to fix it.
...
but I've not been able to get it to work.
